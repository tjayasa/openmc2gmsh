...
gmsh.model.occ.addBox(-R, -R, -R, 3 * R, 3 * R, 2 * R, 4)
gmsh.model.occ.addSphere(0, 0, 0, Rt, 2)
gmsh.model.occ.addCylinder(0,0,0,0,0,5,1, 3)
outdim_tags = []
print(gmsh.model.occ.fuse(outdim_tags, [(3, 1), (3, 2), (3, 3), (3, 4)]))
print(outdim_tags)
# print(gmsh.model.occ.fragment([(3, 1),(3, 2)], [(3, 3), (3, 4)]))
